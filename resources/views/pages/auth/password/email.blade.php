            ...
            <div class="row main">
                <div class="panel-heading">
                   <div class="panel-title text-center">
                        <a href="{{ url('/') }}"><h1 class="title">Away Gs</h1></a>
                        <div class="reset">
                ...
                <div class="main-reset main-center">
                     <div class="row">
                        ...
                        <form class="form-horizontal" method="POST" action="{{ url('password/email')}}">
                            ...
                            <div class="form-group">
                                <button type="submit" class="btn btn-primary btn-lg btn-block reset-button">{{ trans('adminlte_lang::message.sendpassword') }}</button>
                            </div>
